...
class Application(Frame):
    ...
    def Compare(self):
        ...
        if self.file4 == '' and CheckVar5 == 0:
            self.file4 = 'reportH2'
        if self.file4 == '' and CheckVar5 == 1:
            self.file4 = 'report'
        ...
        if os.path.isdir(self.file1) is True and os.path.isdir(self.file2) is True:
            ...
            if CheckVar5.get() == 1:
                current_path = os.getcwd().replace('\\','/') + '/' + 'report.txt'
            ...
            if self.file3 == 'Default: same folder of the running program' and (self.file4 == 'Default: reportH2.html' or self.file4 == 'Default: report.txt'):
                if CheckVar2.get() == 1:
                    webbrowser.open_new_tab('file:///' + current_path)
                    print current_path
                self.Text_G.configure(text = '  Comparison process is completed !')
            ...
            if CheckVar5.get() == 0:
                ...
                if self.file4 == 'Default: report.txt':
    ...
    def disable_button(self):
        if CheckVar5.get() == 1:
            ...
            self.Text_E.insert(0, 'Default: report.txt')
        else:
